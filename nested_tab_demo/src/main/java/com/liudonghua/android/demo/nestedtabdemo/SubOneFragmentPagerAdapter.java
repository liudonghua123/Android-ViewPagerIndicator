 ...
 */
public class SubOneFragmentPagerAdapter extends FragmentPagerAdapter implements IconPagerAdapter {

    private String[] titles;
    private int[] icons;
    private String[] contents;

    public SubOneFragmentPagerAdapter(FragmentManager fm, String[] titles, int[] icons, String[] contents) {
        super(fm);
        this.titles = titles;
        this.icons = icons;
